...
# 3.15
@pytest.mark.randomize(liste1=list_of(str, min_items=1, max_items=10), liste2=list_of(str, min_items=1, max_items=10), min_num=0, max_num=50, ncalls=10)
def test_ternary_tree(liste1, liste2):
    abr = exo2_1.find_words(exo2_1.fusion_exo3(liste1, liste2))
    for e in liste1:
        assert e in abr
    for e in liste2:
        assert e in abr
